...
class Fireboy(pygame.sprite.Sprite):
    ...
    def load_animation_frames(self):
            ...
            for i in range(1,pocet):
                ...
                img = pygame.transform.scale(img, (FIREBOY_WIDTH, FIREBOY_HEIGHT)*FIREBOY_SCALE)
            ...
            right_animations = [pygame.transform.scale(img, (FIREBOY_WIDTH, FIREBOY_HEIGHT)) for img in right_animations]
